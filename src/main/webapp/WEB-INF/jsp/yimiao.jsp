    ...
    <div class="sidebar px-4 py-4 py-md-5 me-0">
        <div class="d-flex flex-column h-100">
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li><a class="m-link active" href="/toyimiao.do"><i class="icofont-aids"></i> <span>预约疫苗接种</span></a></li>
        ...
        <div class="body d-flex py-3">
            ...
            <div class="card mb-3">
                <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                    <h6 class="mb-0 fw-bold ">疫苗接种预约</h6> 
                </div>
                <div class="card-body">
                    <form action="/insertyuyue2.do" method="post">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-md-6">
                                <label class="form-label" >疫苗类型</label>
                                <select name="vaccinetype" class="form-control">
                                    <option hidden></option>
                                        <option value="北京生物">北京生物</option>
                                    <option value="北京科兴">北京科兴</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label for="admittime" class="form-label">预约时间</label>
                                <input type="datetime-local" class="form-control" id="admittime" required="" name="time">
                            </div>
                            ...
                            <div class="col-md-6">
                                <label class="form-label" >预约医院</label>
                                <select name="hospitalname" class="form-control">
                                <option hidden></option>
                                <C:forEach items="${hospitalnamelist}" var="name">
                        ...
                        <button type="submit" class="btn btn-primary mt-4" >预约缴费</button>
                    </form>
                    <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                        <h6 class="mb-0 fw-bold "><font color="red">${msg}</font></h6>
                    </div>
                </div>
            </div>
        </div>      
