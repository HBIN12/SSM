    ...
    <div class="sidebar px-4 py-4 py-md-5 me-0">
        <div class="d-flex flex-column h-100">
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li><a class="m-link active" href="/tomerngyarea.do"><i class="icofont-exclamation-square"></i> <span>风险地区</span></a></li>
            ...
            <div class="container-xxl">
                ...
                <table id="myProjectTable" class="table table-hover align-middle mb-0" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="fw-bold text-secondary">${result3.region}</td>
                            <td><a href="javascript:;">${result3.reportingperson}</a></td>
                            <td><span class="badge bg-lavender-purple">${result3.risksituation}</span></td>
                        </tr>
                            </c:forEach>
