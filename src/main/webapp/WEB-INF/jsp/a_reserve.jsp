    ...
    <div class="wrapper">
			...
			<div class="data-scrollbar" data-scroll="1">
				<nav class="iq-sidebar-menu">
					<ul id="iq-sidebar-toggle" class="side-menu">    
						...
						<li class=" sidebar-layout">
							<a href="tov_condition.do" class="svg-icon">
								<i class="">
									<svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewbox="0 0 24 24" stroke="currentColor">
		...
		<div class="content-page">
			<div class="container-fluid">
				...
				<select onChange='document.location.href=this.options[this.selectedIndex].value;' class="select">
					<option value="" selected>核酸检测</option>
					<option value="tov_reserve.do">疫苗接种</option>
				</select>			
													...
													<table class="table data-table mb-0">
														...
														<c:forEach items="${reserves}" var="reserve">
															<tr class="white-space-no-wrap">												
																<td>
																	<span class="font-weight-bold">${reserve.name}</span>
																</td>
																...
																<td>
																	<fmt:formatDate value="${reserve.time}" pattern="yyyy-MM-dd HH:mm:ss"/>
																</td>
																...
																<td valign="center">
																	<br />
																	<a href="changepass.do?cid=${reserve.cid}&ispass=1"><button  style="border:none;background-color:#fff;">
																		<img src="img/true.png"  height="25px" width="25px"/>
																	</button></a>
																								
																	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

																	<a href="changepass.do?cid=${reserve.cid}&ispass=0"><button style="border:none;background-color:#fff;">
																		<img src="img/false.png"  height="25px" width="25px"/>
																	</button></a>
