    ...
    <div class="sidebar px-4 py-4 py-md-5 me-0">
        <div class="d-flex flex-column h-100">
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li><a class="m-link  active" href="/tojinjishangbao.do"><i class="icofont-hospital fs-5"></i> <span>紧急上报</span></a></li>
        ...
        <div class="body d-flex py-3">
            ...
            <div class="card mb-3">
                <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                    <h6 class="mb-0 fw-bold ">紧急上报病情</h6> 
                </div>
                <div class="card-body">
                    <form action="/insertpatient.do" method="post">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="emailaddress" required="" name="place">
                            </div>

                            <div class="col-md-6">
                                <label for="admittime" class="form-label">发现病情时间点</label>
                                <input type="datetime-local" class="form-control" id="admittime" required="" name="time">
                            </div>
                            
                        </div>
                        
                        <button type="submit" class="btn btn-primary mt-4" >提交上报</button>
                    </form>
                    <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
