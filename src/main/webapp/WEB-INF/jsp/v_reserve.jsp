		...
		<div class="content-page">
			<div class="container-fluid">
				...
				<select onChange='document.location.href=this.options[this.selectedIndex].value;'>
					<option value="toa_reserve.do">核酸检测</option>
					<option value="" selected>疫苗接种</option>
				</select>			
											...
											<div class="card-body p-0">                                
												<div class="table-responsive">
													<table class="table data-table mb-0">
														...
														<tbody>
														<c:forEach items="${vaccs}" var="vacc">
															<tr class="white-space-no-wrap">												
																<td>
																	<span class="font-weight-bold">${vacc.name}</span>
																</td>
																...
																<td valign="center">
																	<br />
																	<a href="changevpass.do?cid=${vacc.cid}&ispass=1"><button  style="border:none;background-color:#fff;">
																		<img src="img/true.png"  height="25px" width="25px"/>
																	</button>
																	</a>
																								
																	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																	<a href="changevpass.do?cid=${vacc.cid}&ispass=0">
