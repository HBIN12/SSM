    ...
    <div class="sidebar px-4 py-4 py-md-5 me-0">
        <div class="d-flex flex-column h-100">
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li><a class="m-link active" href="/topayment.doy"><i class="icofont-money-bag"></i> <span>预约中心</span></a></li>
        ...
        <div class="body d-flex py-3">
            <div class="card mb-3">
                <div class="card-header py-3  bg-transparent border-bottom-0">
                    <h6 class="mb-0 fw-bold ">核酸预约管理</h6>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                  ...
                                  <c:forEach items="${nlist}" var="n">
                                      <tr>
                                        <td>${n.hospitalname}</td>
                                        <td>核酸检测</td>
                                        <td><fmt:formatDate value="${n.time}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                          <td><span class="badge bg-lavender-purple">${n.ispass}</span></td>
            ...
            <div class="card mb-3">
                <div class="card-header py-3  bg-transparent border-bottom-0">
                    <h6 class="mb-0 fw-bold ">疫苗预约管理</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <c:forEach items="${vlist}" var="v">
                                <tr>
                                    ...
                                    <td><span class="badge bg-lavender-purple">${v.ispass}</span></td>
                                </tr>
                            </c:forEach>
