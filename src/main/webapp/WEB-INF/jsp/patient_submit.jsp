											...
											<table class="table data-table mb-0">
												...
												<c:forEach items="${patiens}" var="p">
													<tr class="white-space-no-wrap">
														...
														<td>
															<fmt:formatDate value="${p.time}" pattern="yyyy-MM-dd HH:mm:ss"/>
														</td>
														...
														<td valign="center">
															<br />
															<a href="changepatient.do?idcard=${p.idcard}&place=${p.place}&diagnosisresults=阳性"><button class="btn-danger">紧急上报（阳性）

															</button></a>

															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

															<a href="changepatient.do?idcard=${p.idcard}&place=${p.place}&diagnosisresults=阴性"><button  class="btn-dark">取消上报（阴性）
